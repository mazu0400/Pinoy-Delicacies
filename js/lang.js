const translations = {
  en: {
    ...
    DeliveryNote: "NOTE! If you selected 'Other', please note that delivery costs start from €7.80 depending on the size of the order.",
...
For deliveries to the rest of Finland via Matkahuolto or in another way, please place your order and contact us by phone or email to arrange the delivery.`,
    ...
    DeliveryNote: "HUOM! Jos valitsit vaihtoehdon jokin muu, huomioithan että toimituskulut ovat alkaen 7.80€ tilauksen koosta riippuen.",
    privacyText: "Lue",
...
Muualle Suomeen Matkahuollon kautta tai muulla tavalla, ota yhteyttä puhelimitse tilauksen yhteydessä.`,
    ...
    mainli15:
      "Tietojen käyttö on rajattu valtuutetuille henkilöille (kokki).",
  ...
  tl: {
    ...
    DeliveryNote: "PAALALA! Kung pinili mo ang 'Iba pa', tandaan na ang delivery fee ay nagsisimula sa €7.80 depende sa laki ng order.",
